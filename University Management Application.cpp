...
public:
    ...
    void displayfte()
    {
        ...
        cout<<r7;
        cout<<endl;
        cout<<"\n\t\t "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"               ARJUNA INSTITUTE OF SCIENCE AND TECHNOLOGY"<<endl;
        cout<<"\t\t "<<r6<<" ARJUNA "<<r6<<"                FACULTY OF ENGINEERING AND TECHNOLOGY,\n";
        cout<<" \t\t "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                         KAKINADA.\n";
        cout<<" \t\t                              Accredited with Grade A by JNTUK,\n";
        cout<<" \t\t                        Education Department, Govt. of ANDHRA PRADESH.\n\n";
        for(int i=0;i<118;i++)
        cout<<r7;
        cout<<endl;
        home();
...
public:
    ...
    void result(string id)
    {
        ...
        for(int i=1;i<66;i++)
            cout<<r5;
            cout<<r4<<endl;
        cout<<"\t"<<r6<<" "<<r1<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r4<<"     ARJUNA INSTITUE OF SCIENCE AND TECHNOLOGY   "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r6<<" ARJUNA "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                      KAKINADA.                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Accredited with Grade A by JNYUK,        "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of ANDHRA PRADESH.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
...
else
{
     ...
     void fee_reciept(string id)
    {
        ...
        cout<<"\t"<<r6<<" "<<r6<<" ARJUNA "<<r6<<"        FACULTY OF ENGINEERING AND TECHNOLOGY,      "<<r6<<endl;
        cout<<"\t"<<r6<<" "<<r2<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r5<<r3<<"                    KAKINADA                  "<<r6<<endl;
        cout<<"\t"<<r6<<"                          Accredited with Grade A by JNTUK,        "<<r6<<endl;
        cout<<"\t"<<r6<<"                      Education Department, Govt. of ANDHRA PRADESH.    "<<r6<<endl;
        cout<<"\t"<<r6<<"                                                                 "<<r6<<endl;
